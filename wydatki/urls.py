...
urlpatterns = [
    ...
    url(r'^update/profile/(?P<pk>\d+)/$', views.edit_user, name='profile-update'),
    ...
    url(r'^delete/incomesource/(?P<pk>\d+)/$', views.IncomeSourceDeleteView.as_view(), name='income-source-delete'),
]
